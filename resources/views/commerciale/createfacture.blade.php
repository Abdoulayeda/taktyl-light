...
<div class="pt-12 flex justify-center ">
    ...
    <form action="{{ route('storefacture', $client) }}" method="post" class="w-1/2">
       @csrf
       <div>
        <input type="hidden" value="{{ $client->id }}" >
       </div>
       <div>
        <input type="hidden" value="{{ $client->ab }}" >
       </div>
       <div class="pt-6 pb-6">
        <label for="" class="text-white text-2xl pb-6">Date de la facture</label> <br>
